  ...
  return (
    <section className="bg-[#f4f8fc] py-10 md:py-14">
      <div className="mx-auto grid w-full max-w-6xl gap-8 px-4 lg:grid-cols-[1fr_0.9fr] lg:items-stretch">
        <article className="rounded-2xl border border-[#d9e5f1] bg-white p-6 shadow-sm sm:p-8 lg:p-10">
          <div className="mb-8">
            <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#DDEAF6] text-[#235784]">
              {icon}
            </div>
            <h1 className="mb-2 font-mulish text-3xl font-extrabold text-[#040b11] sm:text-4xl">
              {title}
            </h1>
            <div className="font-open-sans text-[15px] leading-6 text-[#5f6d79]">
              {subtitle}
            </div>
          </div>
          {children}
        ...
        <aside className="hidden overflow-hidden rounded-2xl bg-[#17354f] lg:block">
